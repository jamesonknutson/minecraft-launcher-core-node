...
//# sourceMappingURL=minecraft.d.ts.map`;e["@xmcl/installer/optifine.d.ts"]=`import { MinecraftLocation, Version } from "@xmcl/core"; import { InstallOptions } from "./utils";
...
//# sourceMappingURL=player.d.ts.map`;e["@xmcl/nbt/index.d.ts"]=`/**  * The nbt module provides nbt {@link serialize} and {@link deserialize} functions.
 *
 * @packageDocumentation
 * @module @xmcl/nbt
 */
...
//# sourceMappingURL=index.d.ts.map`;e["@xmcl/user/auth.d.ts"]=`import { GameProfile } from "./base"; export declare const v5: (s: string) => string;
